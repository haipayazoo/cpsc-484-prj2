...
spheres_o.ppm: mrraytracer
	time -p ./mrraytracer --scene spheres -o spheres_o.ppm

spheres_p.ppm: mrraytracer
	time -p ./mrraytracer --scene spheres -o spheres_p.ppm --perspective

ballpit_o.ppm: mrraytracer
	time -p ./mrraytracer --scene ballpit -o ballpit_o.ppm

ballpit_p.ppm: mrraytracer
	time -p ./mrraytracer --scene ballpit -o ballpit_p.ppm --perspective
